...
export default function ArchivePage() {
  return (
    <PageShell eyebrow="Archive / Field Dispatches" title="Dispatches from Deep Time">
      <div className="space-y-0 max-w-3xl">
        ...
        {dispatches.map((dispatch, i) => (
          <motion.article
            ...
            className="group border-b border-ash/30 py-12 hover:pl-4 transition-all duration-700 cursor-default"
          >
            ...
            <h2 className="font-display text-xl md:text-2xl font-light tracking-tight mb-4">
              {dispatch.title}
            </h2>
            <p className="font-display text-base md:text-lg leading-relaxed text-ink/60 max-w-2xl group-hover:text-ink/80 transition-colors duration-700">
              {dispatch.excerpt}
            </p>
          </motion.article>
        ))}
        ...
        >
          <p className="font-mono-label text-ash mb-2">
            The archive continues.
          </p>
          <p className="font-mono-label text-ash">
            New dispatches arrive at the speed of dust.
          </p>
        </motion.div>
      </div>
    </PageShell>
